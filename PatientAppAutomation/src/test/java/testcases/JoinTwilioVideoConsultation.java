...
public class JoinTwilioVideoConsultation extends TestBase {
	...
	@FrameworkAnnotation(author= {"Husain"},category = CategoryType.JoinTwilioVideoConsultation)
	@Test(enabled=true,description="Join Twilio Video Call")
	public void JoinVideoConsultationTest() throws InterruptedException
	{
		...
		driver.findElement(MobileBy.AndroidUIAutomator(String.format("new UiSelector().text(\"Join Call\")"))).click();
		ExtentLogger.pass("Join Call Button is clicked inside Twilio App");	
